...
export default function GenrePage() {
    ...
    const {
        ...
        loading,
        updateUrl,
    } = useFetchSolution(`https://api.rawg.io/api/games?key=9269195f491e44539d7a2d10ce87ab15&genres=${genre}&page=1`);

    useEffect(() => {
        updateUrl(`https://api.rawg.io/api/games?key=9269195f491e44539d7a2d10ce87ab15&genres=${genre}&page=1`);
    }, [genre, updateUrl]);
